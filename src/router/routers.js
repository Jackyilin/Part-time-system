...
export default [{
    ...
    },
    {
        ...
        name: 'choice',
        meta: {
            access: ['super_admin', 'admin', 'yurui', 'chenyilin'],
            title: 'Choice - 选择',
            hideInMenu: true
        },
        component: () =>
            import ('@/view/choice/choice.vue')
    },
    {
        path: '/register',
        name: 'register',
    ...
    },
    {
        ...
        children: [{
            ...
            component: () =>
                ...
                import ('@/view/components/learnha/learnha.vue')
        }]
    },
    {
        path: '/look',
        ...
        component: Main,
        meta: {
            access: ['super_admin', 'admin', 'yurui'],
            title: '求职信息',
            icon: 'ios-book'
        },
        children: [{
    ...
    },
    {
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/check-unit/check-unit.vue')
        }]
    },
    // {
    //     path: '/check',
    ...
    },
    {
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/check-student/check-student.vue')
        }]
    },
    {
        path: '/employer',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/employer/employer.vue')
        }]
    },
    {
        path: '/pulish',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/pulish/pulish.vue')
        }]
    },
    {
        path: '/mypulish',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/mypulish/mypulish.vue')
        }]
    },
    {
        path: '/edit',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/edit-resume/edit-resume.vue')
        }]
    },
    {
        path: '/deliver',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/deliver/deliver.vue')
        }]
    },
    {
        path: '/likes',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/likes/likes.vue')
        }]
    },
    {
        path: '/report',
        ...
        children: [{
            ...
            component: () =>
                // import ('@/view/single-page/home')
                import ('@/view/components/report/report.vue')
        }]
    },
    // {
    //     path: '/join',
